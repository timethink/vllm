...
def is_byte_v2_kv_cache(kv_cache_dtype: str) -> bool:
    return kv_cache_dtype == "byte_v2"


def is_compressed_kv_cache(kv_cache_dtype: str) -> bool:
    return is_quantized_kv_cache(kv_cache_dtype) or is_byte_v2_kv_cache(
        kv_cache_dtype
    )
