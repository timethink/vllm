...
from vllm.utils.torch_utils import is_byte_v2_kv_cache, is_quantized_kv_cache
...
def _get_backend_priorities(
    ...
    if kv_cache_dtype is not None and is_byte_v2_kv_cache(kv_cache_dtype):
        return [AttentionBackendEnum.BYTE_V2]
